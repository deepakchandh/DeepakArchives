...
public class RabinKarp {
	...
	public static void main(String args[]){
        ...
        System.out.println(rks.patternSearch("abedabc".toCharArray(), "abc".toCharArray()));
    }

	private int patternSearch(char[] text, char[] pattern) {
		int m = pattern.length;
        int n = text.length;
        long patternHash = createHash(pattern, m - 1);//1282
        long textHash = createHash(text, m - 1);//1300
		//7-3+1 = 5
